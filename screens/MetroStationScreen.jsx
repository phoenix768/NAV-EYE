...
const MetroStationsScreen = () => {
    ...
    const fetchLocation = async () => {
      ...
      Geolocation.getCurrentPosition(
        (position) => {
          ...
          getNearbyStations({ variables: { lat: latitude, lng: longitude, type: "subway_station" } });
        },
  ...
  const speakStations = () => {
    if (data?.getNearbyStations?.length > 0) {
      ...
      Tts.speak(`Here are the nearby metro stations. ${speechText}`);
    } else {
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>No metro or subway stations found nearby</Text>
          </View>
        }
      />
